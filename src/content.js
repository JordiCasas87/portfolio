    ...
    projects: {
      ...
      projects: [
        ...
        },
        {
          ...
          media: [
            { type: 'image', src: '/images/optimized/kakebot/presentation.jpg', label: 'Presentation' },
            { type: 'image', src: '/images/optimized/kakebot/dashboard.jpg', label: 'Desktop usage' },
            { type: 'image', src: '/images/optimized/kakebot/expense-entry.jpg', label: 'Expense entry' },
            { type: 'image', src: '/images/optimized/kakebot/telegram.jpg', label: 'Telegram' },
            { type: 'image', src: '/images/optimized/kakebot/login.jpg', label: 'Access' },
        ...
        },
        {
          ...
          media: [
            { type: 'image', src: '/images/optimized/wolves/login.jpg', label: 'Login' },
            { type: 'image', src: '/images/optimized/wolves/cover.jpg', label: 'Cover' },
            { type: 'image', src: '/images/optimized/wolves/home.jpg', label: 'Home' },
            { type: 'image', src: '/images/optimized/wolves/avatar.jpg', label: 'Avatar' },
            { type: 'image', src: '/images/optimized/wolves/match.jpg', label: 'Match' },
            { type: 'image', src: '/images/optimized/wolves/admin.jpg', label: 'Admin' },
            { type: 'image', src: '/images/optimized/wolves/admin-panel.jpg', label: 'Admin panel' },
            { type: 'image', src: '/images/optimized/wolves/final.jpg', label: 'Final' },
            { type: 'image', src: '/images/estructura%20wolves.png', label: 'Structure', fit: 'contain' },
            { type: 'image', src: '/images/optimized/wolves/poster.jpg', label: 'Poster' },
          ],
          highlights: [
    ...
    projects: {
      ...
      projects: [
        ...
        },
        {
          ...
          media: [
            { type: 'image', src: '/images/optimized/kakebot/presentation.jpg', label: 'Presentación' },
            { type: 'image', src: '/images/optimized/kakebot/dashboard.jpg', label: 'Uso en ordenador' },
            { type: 'image', src: '/images/optimized/kakebot/expense-entry.jpg', label: 'Registro' },
            { type: 'image', src: '/images/optimized/kakebot/telegram.jpg', label: 'Telegram' },
            { type: 'image', src: '/images/optimized/kakebot/login.jpg', label: 'Acceso' },
        ...
        },
        {
          ...
          media: [
            { type: 'image', src: '/images/optimized/wolves/login.jpg', label: 'Acceso' },
            { type: 'image', src: '/images/optimized/wolves/cover.jpg', label: 'Portada' },
            { type: 'image', src: '/images/optimized/wolves/home.jpg', label: 'Portada' },
            { type: 'image', src: '/images/optimized/wolves/avatar.jpg', label: 'Personaje' },
            { type: 'image', src: '/images/optimized/wolves/match.jpg', label: 'Partida' },
            { type: 'image', src: '/images/optimized/wolves/admin.jpg', label: 'Administrador' },
            { type: 'image', src: '/images/optimized/wolves/admin-panel.jpg', label: 'Panel de administración' },
            { type: 'image', src: '/images/optimized/wolves/final.jpg', label: 'Final' },
            { type: 'image', src: '/images/estructura%20wolves.png', label: 'Estructura', fit: 'contain' },
            { type: 'image', src: '/images/optimized/wolves/poster.jpg', label: 'Póster' },
          ],
          highlights: [
